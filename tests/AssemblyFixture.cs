...
public static class AssemblyFixture
{
    ...
    private static string PluginDllPath =>
        Path.GetFullPath(Path.Combine(
            ...
            "PepperDash.Essentials.Plugins.Crestron.Io.dll"));
    ...
    private static MetadataLoadContext CreateContext()
    {
        ...
        // NOT deps.json - plugin csprojs use <ExcludeAssets>runtime</ExcludeAssets> on the
    ...
    private static IEnumerable<string> ResolveProjectAssetsAssemblies(string assetsJsonPath)
    {
        ...
        // hard-coding "net8.0" (restores can key it slightly differently).
    ...
    // base, not just direct subclasses. A direct-BaseType-only check silently misses those and
    // returns 0 factories.
